...
var _user$project$Level_End$help = function (isGood) {
	var text = isGood ? 'Good job, child!' : 'Restart here =>';
	return _evancz$elm_graphics$Collage$toForm(
		_evancz$elm_graphics$Element$centered(
			A2(
				...
				_evancz$elm_graphics$Text$monospace(
					_evancz$elm_graphics$Text$fromString(text)))));
};
var _user$project$Level_End$door = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$purple,
	A2(_evancz$elm_graphics$Collage$rect, 20, 40));
var _user$project$Level_End$characterBody = A2(
	_evancz$elm_graphics$Collage$moveY,
	-10,
	A2(
		_evancz$elm_graphics$Collage$filled,
		_elm_lang$core$Color$white,
		A2(_evancz$elm_graphics$Collage$rect, 10, 15)));
var _user$project$Level_End$characterHead = A2(
	_evancz$elm_graphics$Collage$moveY,
	6,
	A2(
		_evancz$elm_graphics$Collage$filled,
...
var _user$project$Level_End$character = _evancz$elm_graphics$Collage$group(
	{
		ctor: '::',
		_0: _user$project$Level_End$characterHead,
		_1: {
			ctor: '::',
			_0: _user$project$Level_End$characterBody,
			_1: {ctor: '[]'}
		}
	});
var _user$project$Level_End$subtitle = _evancz$elm_graphics$Collage$toForm(
	_evancz$elm_graphics$Element$centered(
		A2(
			_evancz$elm_graphics$Text$height,
			20,
			A2(
				...
				_evancz$elm_graphics$Text$monospace(
					_evancz$elm_graphics$Text$fromString('By Chris Andrejewski'))))));
var _user$project$Level_End$title = _evancz$elm_graphics$Collage$toForm(
	_evancz$elm_graphics$Element$centered(
		A2(
			_evancz$elm_graphics$Text$height,
			40,
			A2(
				...
				_evancz$elm_graphics$Text$monospace(
					_evancz$elm_graphics$Text$fromString('You won, yay..'))))));
var _user$project$Level_End$block = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$gray,
	A2(_evancz$elm_graphics$Collage$rect, 20, 20));
var _user$project$Level_End$height = 400;
var _user$project$Level_End$width = 400;
var _user$project$Level_End$floor = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$gray,
	A2(_evancz$elm_graphics$Collage$rect, _user$project$Level_End$width, 5));
var _user$project$Level_End$background = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$black,
	A2(_evancz$elm_graphics$Collage$rect, 400, 400));
var _user$project$Level_End$view = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			{
				ctor: '::',
				_0: _user$project$Level_End$background,
				_1: {
					ctor: '::',
					_0: A2(_evancz$elm_graphics$Collage$moveY, 20, _user$project$Level_End$title),
					_1: {
						ctor: '::',
						_0: A2(_evancz$elm_graphics$Collage$moveY, -20, _user$project$Level_End$subtitle),
						_1: {
							ctor: '::',
							_0: A2(_evancz$elm_graphics$Collage$moveY, -195, _user$project$Level_End$floor),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$elm_graphics$Collage$move,
									{ctor: '_Tuple2', _0: -190, _1: -185},
									_user$project$Level_End$block),
								_1: {
									ctor: '::',
									_0: A2(
										_evancz$elm_graphics$Collage$move,
									...
									_1: {
										...
										_0: A2(
											_evancz$elm_graphics$Collage$move,
											{ctor: '_Tuple2', _0: 160, _1: -172},
											_user$project$Level_End$door),
										_1: {
											ctor: '::',
											_0: A2(
												_evancz$elm_graphics$Collage$move,
												{ctor: '_Tuple2', _0: 80, _1: -160},
												_user$project$Level_End$help(false)),
											_1: {
												ctor: '::',
												_0: A2(
													_evancz$elm_graphics$Collage$move,
													{ctor: '_Tuple2', _0: model.x, _1: model.y},
													_user$project$Level_End$character),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Level_End$isWithin = F3(
	function (min, max, num) {
		return (_elm_lang$core$Native_Utils.cmp(num, min) > 0) && (_elm_lang$core$Native_Utils.cmp(num, max) < 0);
	});
var _user$project$Level_End$shouldAdvance = function (model) {
	return A3(_user$project$Level_End$isWithin, 150, 170, model.x);
};
var _user$project$Level_End$movement = F2(
	function (time, model) {
		...
		if (_p0.ctor === 'Just') {
			var newX = A2(
				_elm_lang$core$Basics$min,
				175,
				A2(_elm_lang$core$Basics$max, -175, model.x + ((0.25 * _p0._0) * time)));
			return _elm_lang$core$Native_Utils.update(
				model,
				{x: newX});
		} else {
...
var _user$project$Level_End$gravity = F2(
	function (time, model) {
		var minHeight = -176;
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				y: A2(_elm_lang$core$Basics$max, minHeight, model.y - (0.25 * time))
			});
	});
var _user$project$Level_End$updateDirection = F2(
	function (key, model) {
		var _p1 = key;
		switch (_p1) {
			case 37:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						direction: _elm_lang$core$Maybe$Just(-1)
					});
			case 39:
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Level_End$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Frame':
				var _p3 = _p2._0;
				var newModel = A2(
					_user$project$Level_End$movement,
					_p3,
					A2(_user$project$Level_End$gravity, _p3, model));
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Level_End$updateDirection, _p2._0, model),
...
var _user$project$Level_End$init = {x: -170, y: 180, direction: _elm_lang$core$Maybe$Nothing};
var _user$project$Level_End$Model = F3(
	function (a, b, c) {
		return {x: a, y: b, direction: c};
	});
var _user$project$Level_End$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _user$project$Level_End$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Level_End$Frame = function (a) {
	return {ctor: 'Frame', _0: a};
};
var _user$project$Level_End$subscriptions = _elm_lang$core$Platform_Sub$batch(
	{
		ctor: '::',
		_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Level_End$KeyDown),
		_1: {
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$ups(_user$project$Level_End$KeyUp),
			_1: {
				ctor: '::',
				_0: _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Level_End$Frame),
				_1: {ctor: '[]'}
			}
		}
	});

var _user$project$Level_Start$help = function (isGood) {
	var text = isGood ? 'Good job, child!' : 'Start here =>';
	return _evancz$elm_graphics$Collage$toForm(
		_evancz$elm_graphics$Element$centered(
			A2(
				_evancz$elm_graphics$Text$color,
...
var _user$project$Level_Start$door = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$purple,
	A2(_evancz$elm_graphics$Collage$rect, 20, 40));
var _user$project$Level_Start$characterBody = A2(
	_evancz$elm_graphics$Collage$moveY,
	-10,
	A2(
		_evancz$elm_graphics$Collage$filled,
		_elm_lang$core$Color$white,
		A2(_evancz$elm_graphics$Collage$rect, 10, 15)));
var _user$project$Level_Start$characterHead = A2(
	_evancz$elm_graphics$Collage$moveY,
	6,
	A2(
		_evancz$elm_graphics$Collage$filled,
		_elm_lang$core$Color$white,
		_evancz$elm_graphics$Collage$circle(5)));
var _user$project$Level_Start$character = _evancz$elm_graphics$Collage$group(
	{
		ctor: '::',
		_0: _user$project$Level_Start$characterHead,
		_1: {
			ctor: '::',
			_0: _user$project$Level_Start$characterBody,
			_1: {ctor: '[]'}
		}
	});
var _user$project$Level_Start$subtitle = _evancz$elm_graphics$Collage$toForm(
	_evancz$elm_graphics$Element$centered(
		A2(
			_evancz$elm_graphics$Text$height,
			20,
			A2(
				...
				_elm_lang$core$Color$blue,
				_evancz$elm_graphics$Text$monospace(
					_evancz$elm_graphics$Text$fromString('A game for adult children'))))));
var _user$project$Level_Start$title = _evancz$elm_graphics$Collage$toForm(
	_evancz$elm_graphics$Element$centered(
		A2(
			_evancz$elm_graphics$Text$height,
			40,
			A2(
				...
				_elm_lang$core$Color$green,
				_evancz$elm_graphics$Text$monospace(
					_evancz$elm_graphics$Text$fromString('Memesis'))))));
var _user$project$Level_Start$block = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$gray,
	A2(_evancz$elm_graphics$Collage$rect, 20, 20));
var _user$project$Level_Start$height = 400;
var _user$project$Level_Start$width = 400;
var _user$project$Level_Start$floor = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$gray,
	A2(_evancz$elm_graphics$Collage$rect, _user$project$Level_Start$width, 5));
var _user$project$Level_Start$background = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$black,
	A2(_evancz$elm_graphics$Collage$rect, 400, 400));
var _user$project$Level_Start$view = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			_evancz$elm_graphics$Collage$collage,
			400,
			...
			{
				ctor: '::',
				_0: _user$project$Level_Start$background,
				_1: {
					ctor: '::',
					_0: A2(_evancz$elm_graphics$Collage$moveY, 20, _user$project$Level_Start$title),
					_1: {
						ctor: '::',
						_0: A2(_evancz$elm_graphics$Collage$moveY, -20, _user$project$Level_Start$subtitle),
						_1: {
							ctor: '::',
							_0: A2(_evancz$elm_graphics$Collage$moveY, -195, _user$project$Level_Start$floor),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$elm_graphics$Collage$move,
									{ctor: '_Tuple2', _0: -190, _1: -185},
									_user$project$Level_Start$block),
								_1: {
									ctor: '::',
									_0: A2(
										_evancz$elm_graphics$Collage$move,
									...
									_1: {
										...
										_0: A2(
											_evancz$elm_graphics$Collage$move,
											{ctor: '_Tuple2', _0: 160, _1: -172},
											_user$project$Level_Start$door),
										_1: {
											ctor: '::',
											_0: A2(
												_evancz$elm_graphics$Collage$move,
												{ctor: '_Tuple2', _0: 80, _1: -160},
												_user$project$Level_Start$help(false)),
											_1: {
												ctor: '::',
												_0: A2(
													_evancz$elm_graphics$Collage$move,
													{ctor: '_Tuple2', _0: model.x, _1: model.y},
													_user$project$Level_Start$character),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Level_Start$isWithin = F3(
	function (min, max, num) {
		return (_elm_lang$core$Native_Utils.cmp(num, min) > 0) && (_elm_lang$core$Native_Utils.cmp(num, max) < 0);
	});
var _user$project$Level_Start$shouldAdvance = function (model) {
	return A3(_user$project$Level_Start$isWithin, 150, 170, model.x);
};
var _user$project$Level_Start$movement = F2(
	function (time, model) {
		var _p0 = model.direction;
		if (_p0.ctor === 'Just') {
			var newX = A2(
...
var _user$project$Level_Start$gravity = F2(
	function (time, model) {
		var minHeight = -176;
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Level_Start$updateDirection = F2(
	function (key, model) {
		var _p1 = key;
		switch (_p1) {
			case 37:
...
var _user$project$Level_Start$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Frame':
				var _p3 = _p2._0;
				var newModel = A2(
					_user$project$Level_Start$movement,
					_p3,
					A2(_user$project$Level_Start$gravity, _p3, model));
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Level_Start$updateDirection, _p2._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$Level_Start$init = {x: -170, y: 180, direction: _elm_lang$core$Maybe$Nothing};
var _user$project$Level_Start$Model = F3(
	function (a, b, c) {
		return {x: a, y: b, direction: c};
	});
var _user$project$Level_Start$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _user$project$Level_Start$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _user$project$Level_Start$Frame = function (a) {
	return {ctor: 'Frame', _0: a};
};
var _user$project$Level_Start$subscriptions = _elm_lang$core$Platform_Sub$batch(
	{
		ctor: '::',
		_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Level_Start$KeyDown),
		_1: {
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$ups(_user$project$Level_Start$KeyUp),
			_1: {
				ctor: '::',
				_0: _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Level_Start$Frame),
				_1: {ctor: '[]'}
			}
		}
	});
...
var _user$project$Main$SuchDoge = function (a) {
	return {ctor: 'SuchDoge', _0: a};
};
var _user$project$Main$End = function (a) {
...
var _user$project$Main$initialModel = {
	level: _user$project$Main$Start(_user$project$Level_Start$init)
};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$advanceLevel = function (model) {
	var _p0 = model.level;
	switch (_p0.ctor) {
		case 'Start':
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					level: _user$project$Main$SuchDoge(_user$project$Level_SuchDoge$init)
				});
		case 'SuchDoge':
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					level: _user$project$Main$End(_user$project$Level_End$init)
				});
		default:
			return _elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Main$EndMsg = function (a) {
	return {ctor: 'EndMsg', _0: a};
};
var _user$project$Main$SuchDogeMsg = function (a) {
	return {ctor: 'SuchDogeMsg', _0: a};
};
var _user$project$Main$StartMsg = function (a) {
	return {ctor: 'StartMsg', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	var _p1 = model.level;
	switch (_p1.ctor) {
		case 'Start':
			return A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$StartMsg, _user$project$Level_Start$subscriptions);
		case 'SuchDoge':
			return A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Main$SuchDogeMsg,
				_user$project$Level_SuchDoge$subscriptions(_p1._0));
		default:
			return A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$EndMsg, _user$project$Level_End$subscriptions);
	}
};
var _user$project$Main$levelView = function (level) {
	var _p2 = level;
	switch (_p2.ctor) {
		case 'Start':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$StartMsg,
				_user$project$Level_Start$view(_p2._0));
		case 'End':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$EndMsg,
				_user$project$Level_End$view(_p2._0));
		default:
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Main$SuchDogeMsg,
				_user$project$Level_SuchDoge$view(_p2._0));
	}
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$levelView(model.level),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$AdvanceLevel = {ctor: 'AdvanceLevel'};
var _user$project$Main$update = F2(
	function (msg, model) {
		var toLevel = F6(
			function (toModel, toMsg, subAdvance, subUpdate, subMsg, subModel) {
				if (subAdvance(subModel)) {
					return A2(_user$project$Main$update, _user$project$Main$AdvanceLevel, model);
				} else {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								level: toModel(newModel)
							}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, toMsg, newCmd)
					};
				}
			});
		var _p4 = {ctor: '_Tuple2', _0: msg, _1: model.level};
		_v3_4:
		do {
			switch (_p4._0.ctor) {
				case 'AdvanceLevel':
					return {
						ctor: '_Tuple2',
						_0: _user$project$Main$advanceLevel(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'EndMsg':
					if (_p4._1.ctor === 'End') {
						return A6(toLevel, _user$project$Main$End, _user$project$Main$EndMsg, _user$project$Level_End$shouldAdvance, _user$project$Level_End$update, _p4._0._0, _p4._1._0);
					} else {
						break _v3_4;
					}
				case 'StartMsg':
					if (_p4._1.ctor === 'Start') {
						return A6(toLevel, _user$project$Main$Start, _user$project$Main$StartMsg, _user$project$Level_Start$shouldAdvance, _user$project$Level_Start$update, _p4._0._0, _p4._1._0);
					} else {
						break _v3_4;
					}
				default:
					if (_p4._1.ctor === 'SuchDoge') {
						return A6(toLevel, _user$project$Main$SuchDoge, _user$project$Main$SuchDogeMsg, _user$project$Level_SuchDoge$shouldAdvance, _user$project$Level_SuchDoge$update, _p4._0._0, _p4._1._0);
					} else {
						break _v3_4;
					}
			}
